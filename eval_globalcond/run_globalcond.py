...
import dnnlib
from evaluator_globalcond import DPSHyperEvaluator
from utils import post_eval_normalize


def parse_args():
    p = argparse.ArgumentParser(description="GC-PaDIS evaluation runner")
...
def main():
    ...
    print(f'Loading GC-PaDIS network from "{args.model_path}"...')
