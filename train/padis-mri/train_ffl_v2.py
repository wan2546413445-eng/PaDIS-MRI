...
@click.command()
@click.option('--real_p', type=click.FloatRange(min=0, max=1), default=0.5, show_default=True)
@click.option('--train_on_latents', type=bool, default=False, show_default=True)
@click.option('--progressive', type=bool, default=False, show_default=True)
@click.option('--padding', type=bool, default=True, show_default=True)
@click.option('--four_channels', type=int, default=1, show_default=True)
@click.option('--hash_channels', type=int, default=1, show_default=True)
@click.option('--pad_width', type=int, required=True)
...
@click.option('--xflip', type=bool, default=False, show_default=True)
@click.option('--implicit_mlp', type=bool, default=False, show_default=True)
...
@click.option('--ffl_weight', type=float, default=0.05, show_default=True)
@click.option('--ffl_alpha', type=float, default=1.0, show_default=True)
@click.option('--ffl_log_matrix', type=bool, default=False, show_default=True)
@click.option('--ffl_batch_matrix', type=bool, default=False, show_default=True)
@click.option('--ffl_mode', type=click.Choice(['v1', 'robust_hf']), default='robust_hf', show_default=True)
@click.option('--ffl_use_magnitude', type=bool, default=True, show_default=True)
@click.option('--ffl_window', type=click.Choice(['rect', 'hann', 'hamming', 'tukey']), default='tukey', show_default=True)
@click.option('--ffl_tukey_alpha', type=float, default=0.5, show_default=True)
@click.option('--ffl_hp_radius', type=float, default=0.08, show_default=True)
@click.option('--ffl_hp_softness', type=float, default=0.02, show_default=True)
@click.option('--ffl_clip_low', type=float, default=0.10, show_default=True)
@click.option('--ffl_clip_high', type=float, default=0.98, show_default=True)
@click.option('--ffl_sigma_min', type=float, default=0.0, show_default=True)
@click.option('--ffl_sigma_max', type=float, default=0.5, show_default=True)
@click.option('--ffl_sigma_softness', type=float, default=0.05, show_default=True)
...
def main(**kwargs):
    ...
    c = dnnlib.EasyDict()
    c.dataset_kwargs = dnnlib.EasyDict(class_name='training.dataset.ImageFolderDatasetX', path=opts.data, use_labels=opts.cond, xflip=opts.xflip, cache=opts.cache)
    ...
    if opts.precond == 'vp':
        ...
        c.loss_kwargs.ffl_batch_matrix = opts.ffl_batch_matrix
        c.loss_kwargs.ffl_mode = opts.ffl_mode
        c.loss_kwargs.ffl_use_magnitude = opts.ffl_use_magnitude
        c.loss_kwargs.ffl_window = opts.ffl_window
        c.loss_kwargs.ffl_tukey_alpha = opts.ffl_tukey_alpha
        c.loss_kwargs.ffl_hp_radius = opts.ffl_hp_radius
        c.loss_kwargs.ffl_hp_softness = opts.ffl_hp_softness
        c.loss_kwargs.ffl_clip_low = opts.ffl_clip_low
        c.loss_kwargs.ffl_clip_high = opts.ffl_clip_high
        c.loss_kwargs.ffl_sigma_min = opts.ffl_sigma_min
        c.loss_kwargs.ffl_sigma_max = opts.ffl_sigma_max
        c.loss_kwargs.ffl_sigma_softness = opts.ffl_sigma_softness
    else:
    ...
    desc = (
        ...
        f'ffl{opts.ffl_mode}_w{opts.ffl_weight}_a{opts.ffl_alpha}_'
        f'{opts.ffl_window}_hp{opts.ffl_hp_radius}_sig{opts.ffl_sigma_max}'
    )
