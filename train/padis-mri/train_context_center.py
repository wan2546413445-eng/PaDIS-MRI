...
@click.option('--four_channels',       help='Number of Fourier embedding freqs', metavar='INT',                  type=int, default=1, show_default=True)
@click.option('--hash_channels',       help='Number of hash embedding outputs', metavar='INT',                  type=int, default=1, show_default=True)
@click.option('--pad_width',       help='Width on all sides of zero padding', metavar='INT',                  type=int, required=True)
@click.option('--context-margin', help='Extra context pixels around each supervised patch', metavar='INT', type=int, default=0, show_default=True)
