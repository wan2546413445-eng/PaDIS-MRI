...
def main(**kwargs):
    ...
    dataset_name = 'aapm_3'
    desc = f'{dataset_name:s}-{cond_str:s}-{opts.arch:s}-{opts.precond:s}-gpus{dist.get_world_size():d}-batch{c.batch_size:d}-{dtype_str:s}-fflw{opts.ffl_weight}_ffla{opts.ffl_alpha}'
