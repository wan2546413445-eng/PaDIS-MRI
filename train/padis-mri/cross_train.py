...
from training import cross_training_loop as training_loop
...
def main(**kwargs):
    ...
    if opts.precond == 'vp':
        ...
        c.network_kwargs.class_name = 'training.cross_networks.CrossPatch_EDMPrecond'
        c.loss_kwargs.class_name = 'training.cross_patch_loss.CrossPatch_EDMLoss'
    else:
    ...
    if opts.augment:
        raise click.ClickException("Cross branch requires --augment=0")
    if False:
