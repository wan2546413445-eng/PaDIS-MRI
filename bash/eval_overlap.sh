...
SAVE_DIR=$RESULT_ROOT/PaDIS-MRI-recon/shifted_gaussian_sigma1627_full_ckpt014994_s78_f520_shift32_sample${SAMPLE_INDEX}
...
LOG_FILE=$LOG_DIR/eval_shifted_gaussian_sigma1627_full_ckpt010080_s78_f520_shift32_sample${SAMPLE_INDEX}_gpu${GPU}_${TIME_TAG}.log

echo "==================================================" | tee "$LOG_FILE"
echo "PaDIS-MRI Shifted Gaussian Fusion Eval" | tee -a "$LOG_FILE"
echo "sigma_data=0.1627" | tee -a "$LOG_FILE"
