...
# Balanced Haar High-Frequency Overlap
...
EXP_NAME=overlap_structure_wavelet_hf_mix${MIX_TAG}_lam${LAMBDA_TAG}_active64_bgpu1_${PATCH_TAG}_b2_seed${SEED}
...
{
    echo "=================================================="
    echo "PaDIS-MRI Balanced Haar High-Frequency Overlap"
    echo "GPU=$GPU"
    echo "SEED=$SEED"
