...
MODEL_PATH=$RESULT_ROOT/PaDIS-MRI-runs/training-runs-cross/main_cross_patch_s16s32s64_k8_cbase96_b4_fp32/00001-cross_patch_s16s32s64_k8_cbase96_b4_fp32-aapm_3-uncond-ddpmpp-pedm-gpus1-batch6-fp32/network-snapshot-001900.pkl

VAL_DIR=/mnt/SSD/wsy/data/fastmri_batch0_eval/val_t1-flair_subsamp/32dB

SAVE_DIR=/mnt/SSD2/wsy/PaDIS-MRI/PaDIS-MRI-recon/cross_patch_k8_1900k_s78_i10_val1
LOG_DIR=$RESULT_ROOT/results_record/logs
mkdir -p $SAVE_DIR
mkdir -p $LOG_DIR

TIME_TAG=$(date +"%Y%m%d_%H%M%S")
LOG_FILE=$LOG_DIR/eval_cross_patch_k8_1900k_s78_i10_val1_gpu${GPU}_${TIME_TAG}.log
