...
ROOT_OUTDIR=/mnt/SSD2/wsy/PaDIS-MRI/PaDIS-MRI-runs/patch_block/uniform      # root directory of where to save model checkpoints
...
PROBS=0.3333,0.3333,0.3334                           # must sum to 1.0 (will be normalized if not)
